...
// ============================================================
//
// Spread and rest both use the same three dots, but they do
// opposite things. Spread takes the items out of an array or
// object and spreads them apart. Rest collects many items
// together into one. They are among the most used features in
// modern JavaScript.
...
// ------------------------------------------------------------
//
// The spread operator, three dots, takes all the items out of
// an array.

// --- Copying an array ---
//
// You saw earlier that copying an array by assignment does not
// really copy it, both names point to the same array. Spread
// makes a real copy.
...
const combined1 = [...first1, ...second1]
...
const more1 = [1, ...numbers1, 5]

console.log(more1)   // [1, 2, 3, 4, 5]
...
// ------------------------------------------------------------
//
// Spread works the same way for objects, copying all the key
// value pairs.

// --- Copying an object ---

const original2 = { name: "Ahmed", age: 25 }
const copy2 = { ...original2 }

copy2.age = 26

console.log(original2)   // { name: "Ahmed", age: 25 }, unchanged
console.log(copy2)       // { name: "Ahmed", age: 26 }

// --- Combining objects ---

const basic1 = { name: "Ahmed", age: 25 }
const extra1 = { city: "Lahore", job: "Developer" }

const full1 = { ...basic1, ...extra1 }
...
//
// This is a very common pattern. Copy an object but change one
// property.

const person1 = { name: "Ahmed", age: 25, city: "Lahore" }

const updated1 = { ...person1, age: 26 }

console.log(updated1)
// { name: "Ahmed", age: 26, city: "Lahore" }

// The spread copies everything, and then age: 26 overrides the
// old age. The property written later wins. This pattern is
// used constantly in React to update data without changing the
// original.
...
// Math.max expects separate numbers, not an array. Spread turns
// the array into separate values.

// ------------------------------------------------------------
// Rest
// ------------------------------------------------------------
//
// Rest uses the same three dots but does the opposite. It
// collects many separate items into one array. You see the
// difference by where it is used. Spread is used where values
// go out. Rest is used where values come in, like in function
// parameters.

// --- Rest in function parameters ---
//
// A function can accept any number of arguments and collect
// them into an array.
...
// Here numbers collects all the arguments into a single array,
// no matter how many are passed. Then you can use array methods
// on it.
...
// first and second take the first two arguments. others
// collects everything left over into an array.

// ------------------------------------------------------------
// Rest in Destructuring
// ------------------------------------------------------------
//
// Rest also works when destructuring, to collect the leftover
// items.
//
// With arrays.
...
const person2 = { name: "Ahmed", age: 25, city: "Lahore", job: "Dev" }

const { name: name2, ...details1 } = person2

console.log(name2)      // Ahmed
console.log(details1)   // { age: 25, city: "Lahore", job: "Dev" }
...
//
// A simple way to tell them apart. If the three dots are where
// values are being created or passed, it is spread. If the
// three dots are where values are being received or collected,
// it is rest.
...
// Spread spreads out. Rest gathers in. Same three dots, opposite
// direction.
