...
// It also provides number methods and a Math object full of useful tools
// for rounding, powers, and random numbers.
...
// It is very useful for money.
// Note: it returns a string.
...
// Copy this section into a separate a.js file
// and write your code under each exercise.
...
// Take the number 3.14159 and print it with exactly
// two decimal places using toFixed.
...
// Use Math.max and Math.min to find the biggest and
// smallest of these three numbers: 45, 82, 67.
...
// Check whether the numbers 10, 3.5, and 100 are
// integers using Number.isInteger.
...
// Print the absolute value of negative 25.
...
// Print a random decimal using Math.random.
// Run it a few times and notice it changes.
...
// Write the formula to get a random whole number
// between 1 and 6, like a dice roll.
// Print a few rolls.
...
// Write a function called randomBetween that takes
// a min and max and returns a random whole number
// in that range.

// Test it with 1 to 100 and 500 to 600.
...
// Show the floating point problem by printing 0.1 plus 0.2.
// Then fix it using toFixed so it shows 0.30.
...
// Roll two dice for player one and print the total.
// Roll two dice for player two and print the total.

// Compare the totals and print who won
// or if it is a tie.
